const Footer = () => {
    ...
    return (
      // <footer className="bg-[#1C0037] text-[#E2D6F5] w-full mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      //     ))}
      //   </div>
      //   <div className="mt-8 border-t border-[#3A1A5B] pt-8 flex flex-col md:flex-row justify-between items-center">
      ...
      //       <img
      //         src="https://storage.googleapis.com/a1aa/image/lJxpbyOW_636fvMJu9gEh9OxGi_IhbjojxSsjoCZJUM.jpg"
      //         alt="Eventbrite logo"
      //         className="h-5"
      //       />
      //       <img
      //         src="https://storage.googleapis.com/a1aa/image/U5R1Mmwh52eEJsAMjP-XPz2pghbPkQlsWsXEvfjZT0U.jpg"
      //         alt="Ticketfly logo"
      //         className="h-5"
      //       />
      //     </div>
      //   </div>
      //   <div className="mt-4 text-center text-sm">© 2025 Eventbrite</div>
      // </footer>
