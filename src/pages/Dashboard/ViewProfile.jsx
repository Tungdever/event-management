...
const ViewProfile = () => {
  ...
  const fetchFollowingCount = async (email) => {
    try {
      const response = await axios.get(`https://utevent-3e31c1e0e5ff.herokuapp.com/api/follow/following/count/${email}`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
  ...
  const fetchFollowers = async (organizerId) => {
    ...
    try {
      const response = await axios.get(`https://utevent-3e31c1e0e5ff.herokuapp.com/api/follow/followers/${organizerId}`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
  ...
  const fetchFollowingOrganizers = async (email) => {
    try {
      const response = await axios.get(`https://utevent-3e31c1e0e5ff.herokuapp.com/api/follow/list-org/${email}`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
