...
const UserPage = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch('https://utevent-3e31c1e0e5ff.herokuapp.com/api/auth/users', {
  ...
  const fetchRoles = async () => {
    try {
      setError(null);
      if (!token) throw new Error('No token found');
      const response = await fetch('https://utevent-3e31c1e0e5ff.herokuapp.com/api/roles/ADMIN/created', {
        headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
      });
...
const lockUser = async (email) => {
  try {
    const response = await fetch(`https://utevent-3e31c1e0e5ff.herokuapp.com/api/auth/users/${email}/lock`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
    });
    const data = await response.json();
...
const unlockUser = async (email) => {
  try {
    const response = await fetch(`https://utevent-3e31c1e0e5ff.herokuapp.com/api/auth/users/${email}/unlock`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
    });
    const data = await response.json();
