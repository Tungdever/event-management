...
//   const [tags, setTags] = useState(["mental_health", "first_aid", "training", "cpd_accredited", "wellness"]);
//   const [eventVisibility, setEventVisibility] = useState("public");
//   const [publishTime, setPublishTime] = useState("now");
//   const [refunds, setRefunds] = useState("yes");
//   const [validityDays, setValidityDays] = useState(7);
//   const [uploadedImages, setUploadedImages] = useState([]);
//   const [eventTitle, setEventTitle] = useState("Mental Health First Aid (MHFA) Training (CPD Accredited)");
...
//     city: "",
//   });
//   const [overviewContent, setOverviewContent] = useState({ text: "", media: [] });
...
//     try {
//       // Bước 1: Upload file và lấy public_id
...
//         const result = await response.text(); // API trả về chuỗi "File uploaded: <public_id>"
//         const publicId = result.split("File uploaded: ")[1]; // Trích xuất public_id
//         return publicId;
//       };
  
//       // Upload các file trong uploadedImages và lấy danh sách public_id
//       const imagePublicIds = [];
//       for (const image of uploadedImages) {
//         if (image instanceof File) {
//           const publicId = await uploadFileToCloudinary(image);
//           imagePublicIds.push(publicId);
//         } else {
//           // Nếu đã là public_id (từ lần lưu trước), giữ nguyên
//           imagePublicIds.push(image);
//         }
//       }
  
//       // Upload các file trong overviewContent.media và lấy danh sách public_id
//       const mediaPublicIds = [];
//       for (const media of overviewContent.media) {
//         if (media instanceof File) {
//           const publicId = await uploadFileToCloudinary(media);
//           mediaPublicIds.push(publicId);
//         } else {
//           // Nếu đã là public_id (từ lần lưu trước), giữ nguyên
//           mediaPublicIds.push(media);
//         }
//       }
  
//       // Bước 2: Tạo dữ liệu event với public_id
...
//         refunds,
//         validityDays,
//         uploadedImages: imagePublicIds, // Chỉ chứa public_id
//         eventTitle,
//         summary,
//         agendaSlots,
//         locationData,
...
//           media: mediaPublicIds, // Chỉ chứa public_id
//         },
//       };
  
//       // Bước 3: Gửi dữ liệu tới /api/events
...
//       setOverviewContent({
//         text: data.overviewContentText || "",
//         media: data.overviewContentMedia || [],
//       });
//     } catch (error) {
...
//             setLoca tionData={setLocationData}
...
//             </label>
//           ))}
//           {/* Thêm button Complete chỉ hiển thị khi ở bước Publish */}
...
//         {saveStatus === "error" && <p>Error occurred while saving.</p>}
//         {renderStepComponent()}
//       </div>
//     </div>
//   );
...
//     <UploadContainer uploadedImages={uploadedImages} setUploadedImages={setUploadedImages} />
...
// <SectionEvent slots={agendaSlots} setSlots={setAgendaSlots} />
//       <DatetimeLocation formData={locationData} setFormData={setLocationData} />
//       <OverviewSection content={overviewContent} setContent={setOverviewContent} />
