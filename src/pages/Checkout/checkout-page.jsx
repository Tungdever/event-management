...
const CheckoutPage = (props) => {
  ...
  const checkoutHandle = async () => {
    ...
    if (method === "MoMo") {
      try {
        const response = await axios.post('https://event-management-server-asi9.onrender.com/api/v1/payment/create-momo', data, {
          headers: {
      ...
      try {
        const response = await axios.post('https://event-management-server-asi9.onrender.com/api/v1/payment/create-vnpay', data, {
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`
          }
      ...
      try {
        const response = await axios.post('https://event-management-server-asi9.onrender.com/api/v1/payment/paypal/pay', data, {
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`
          }
