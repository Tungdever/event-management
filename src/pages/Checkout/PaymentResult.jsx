        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-gray-900 font-semibold">{data?.orderCode || 'N/A'}</p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-900">{data?.transactionTime ? new Date(data.transactionTime).toLocaleString() : 'N/A'}</p>
          </div>
