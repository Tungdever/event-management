...
const notifications = [
  {
    ...
    image:
      "https://storage.googleapis.com/a1aa/image/RO9a_Km3MzmI6eXhXAX_iepBq_xtGzHYV9VobLWk4Bg.jpg",
    hasActions: true,
  },
  {
    id: 2,
    ...
    time: "5 giờ trước",
    image:
      "https://storage.googleapis.com/a1aa/image/zikBlWLojSoSRz55uD4rJDkt03syxPihqxo11KJOrzc.jpg",
    hasActions: false,
  },
  {
    id: 3,
    name: "Hệ thống",
    message:
      "Sự kiện 'Hội Nghị Trí Tuệ Nhân Tạo' sẽ diễn ra vào ngày mai. Hãy đảm bảo bạn đã đăng ký tham dự.",
    time: "Hôm qua",
    image:
      "https://storage.googleapis.com/a1aa/image/VFzmkOIbebjne3na3F1tAR2DJWjNF1drwnptDa7QyLc.jpg",
    hasActions: false,
  },
  {
    id: 4,
    name: "Lê Thanh Huy",
    message:
      "đã gửi cho bạn lời mời làm diễn giả tại sự kiện 'Xu Hướng Công Nghệ Tương Lai'.",
    time: "2 ngày trước",
    mutualFriends: "3 diễn giả khác cũng tham gia.",
    image:
      "https://storage.googleapis.com/a1aa/image/vQRA-hLZMfFnSRwIJxjyrqnfSO2-Zeuv5EobX8PifwA.jpg",
    hasActions: true,
  },
  {
    id: 5,
    name: "Ban Tổ Chức",
    message:
      "Vé tham dự sự kiện 'Hội Thảo Lãnh Đạo Trẻ' của bạn đã được xác nhận.",
    time: "3 ngày trước",
    image:
      "https://storage.googleapis.com/a1aa/image/RO9a_Km3MzmI6eXhXAX_iepBq_xtGzHYV9VobLWk4Bg.jpg",
    hasActions: false,
  },
  {
    ...
    message:
      "đã gửi cho bạn lời mời kết nối để cùng tham gia 'Hội Thảo Kinh Tế Toàn Cầu'.",
    time: "4 ngày trước",
  ...
  },
  {
    ...
    name: "Hệ thống",
    message:
      "Bạn đã được thêm vào danh sách khách mời của sự kiện 'Hội Nghị Blockchain 2025'.",
    time: "5 ngày trước",
    image:
      "https://storage.googleapis.com/a1aa/image/VFzmkOIbebjne3na3F1tAR2DJWjNF1drwnptDa7QyLc.jpg",
    hasActions: false,
  },
  {
    ...
    message:
      "đã bình luận về bài đăng của bạn trong sự kiện 'Tọa Đàm Đổi Mới Sáng Tạo'.",
    time: "6 ngày trước",
    image:
      "https://storage.googleapis.com/a1aa/image/vQRA-hLZMfFnSRwIJxjyrqnfSO2-Zeuv5EobX8PifwA.jpg",
    hasActions: false,
...
const ticketData = [
  {
    ...
    price: "$50.00",
    image:
      "https://i.pinimg.com/474x/c9/fc/5b/c9fc5b906a994962bbc5d530e1cb9ce6.jpg",
  },
  {
    id: "D4E5F6",
    ...
    price: "$120.00",
    image:
      "https://i.pinimg.com/474x/20/12/68/201268d8c3f9c7f98521b949b8671b92.jpg",
  },
  {
    id: "G7H8I9",
    ...
    price: "$30.00",
    image:
      "https://i.pinimg.com/474x/92/18/4a/92184a471672bcd65d46557674d14206.jpg",
  },
];
...
const profileData = [
  {
    ...
    education:
      "Bachelor's Degree in Event Management, University of California",
  },
];
const MainLayout = () => {
